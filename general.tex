...
\mobile{07787 567865}
\email{will@willwebberley.net}
\homepage{will.now.sh}
...
\textbf{I'm highly proficient in and frequently use a wide range of languages, frameworks, and platforms.}
	...
	\subsection{Platforms, Technologies, Techniques, and Frameworks}
        \cvitem{Proficient}{Git, Docker, Android dev., GNU/Linux \& UNIX-like systems, Flask, Meteor \& Node.js, MongoDB \& CouchDB, jQuery \& AngularJS, WebSocket, Weka, Heroku, AWS, Nginx, Vim, Eclipse/NetBeans}
...
\section{Recent Experience \& Employment}
      \cventry{2015--Present}{Simply Do Ideas}{Chief Technology Officer}{Cardiff, UK}{}{Technical lead on and responsibility for company products.}
    ...
    \cventry{2013--2017}{Cardiff University}{Research Associate and Lecturer}{Cardiff, UK}{}{\textbf{Research} as part of the International Technology Alliance (ITA) coalition between the UK MoD and the US Army Research Labs. I worked with a variety of US and UK academic and industry partners, such as IBM and Boeing, in advancing information and network sciences.

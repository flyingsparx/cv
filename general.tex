...
\textbf{I'm highly proficient in and frequently use a wide range of languages, frameworks, and platforms.}
	...
	\subsection{Platforms, Technologies, Techniques, and Frameworks}
        \cvitem{Proficient}{Git, Android dev., GNU/Linux \& UNIX-like systems, Flask, MongoDB \& CouchDB, jQuery \& AngularJS, WebSocket, Weka, Node.js, Heroku, AWS, Nginx, Vim, Eclipse/NetBeans}
